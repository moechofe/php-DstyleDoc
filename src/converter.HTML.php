...
abstract class ConverterHTML extends Converter
{
  ...
  public function convert_title( $title, Element $element )
  {
    return $title;
  }
  ...
  public function convert_licence( $licence, CustomElement $element )
  {
  ...
  public function convert_id( $id, Element $element )
  {
    if( is_array($id) )
      $id = implode('_', $id);
