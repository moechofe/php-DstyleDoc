...
interface DstyleDoc_Analyseable
{
	...
	/**
	 * PHP deprecie le passage par reference a des fonctions appelés dynamiquement. Pour cette raison : $instance et $priority doivent être des objects.
	 */
...
class DstyleDoc_Analyser_Element_Syntax_List extends DstyleDoc_Analyser implements DstyleDoc_Analyser_Descriptable
{
	 ...
	 *		integer $priority->value = La priorité de l'élément trouvé en cas de succés.
	 * Returns:
