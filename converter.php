...
abstract class Converter extends Properties implements ArrayAccess, ConverterInterface
{
	 ...
	 * Type: DstyleDoc
	 * Members:
	 *   (set,get) DstyleDoc $control = L'instance de DstyleDoc associ̩ au converteur.
	 */
	 ...
	 * Il est pr̩ferable d'acc̬der au membre $_control en ̩criture plut̫t que d'appel̩ cette m̩thode.
	 * Params:
	 ...
	 * Il est pr̩ferable d'acc̬der au membre $_control en lecture plut̫t que d'appel̩ cette m̩thode.
	 * Returns:
