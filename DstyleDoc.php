...
class DstyleDoc extends DstyleDoc_Properties
{
   ...
   * Params:
   *    string,numeric,array ... = Une chaÓne de caractËre, un nombre ou un tableau de pairs clefs/valeurs ‡ afficher.
   * Syntax:
   *    ... = Un nombre infinie de paramËtre ‡ afficher.
   */
...
interface DstyleDoc_Converter_Convert
{
  ...
  /**
   * Renvoie la liste des interfaces appartenant ‡ un fichier donnÈe.
   * Params:
  ...
  /**
   * Converti et renvoie l'identifiant unique d'un ÈlÈment.
   * Params:
   *    string $id = L'identifiant unique de l'ÈlÈment.
   *    array $id = Un tableau contenant la liste des identifiants de l'ÈlÈment et celui de ses parents.
   *    $element = L'ÈlÈment vers lequel se destine le lien.
   * Returns:
   *    string = L'identifiant convertie de l'ÈlÈment.
   */
  ...
  /**
   * Convertie et renvoie le nom d'affichage d'un ÈlÈment.
   * Params:
   *    $name = Le nom de l'ÈlÈment ‡ afficher.
   *    $element = L'ÈlÈment vers lequel se destine le lien.
   * Returns:
   *    mixed = DÈpends du convertisseur.
   */
  ...
  /**
   * GÈnËre la documentation d'une syntaxe d'une fonction.
   * Params:
  ...
  /**
   * GÈnËre la documentation d'un paramËtre d'une fonction.
   * Params:
   *    $param = L'instance du paramËtre.
   * Returns:
   *    mixed = La documentation de la syntaxe ou pas.
   */
  ...
  /**
   * GÈnËre la documentation d'une valeur de retour d'une fonction.
   * Params:
  ...
  /**
   * GÈnÈre la documentation d'un type de valeur.
   * Params:
