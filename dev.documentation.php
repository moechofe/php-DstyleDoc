...
if( empty($_GET['class']) and empty($_GET['method']) and empty($_GET['interface']) and empty($_GET['member']) )
	$_GET['file'] = $script_name;

DstyleDoc::hie()->source($script_name)->convert_with(
	DstyleDoc_Converter_FirstStyle::hie()->template_dir('converter.FirstStyle')
		->config(array(
'skin' => 'rosy',
'charset' => 'utf-8',
